...
| **2** | **Requirements Clarification & Intake** | **ALL** | • `docs/guides/requirements-intake-template.md`<br>• `docs/guides/requirements-traceability-guide.md` (for Req ID format)<br>• `docs/guides/architecture-guide.md`<br>• `docs/reference/tech_stack.md`<br>• `docs/atomic/architecture/improved-hybrid-overview.md` | • Completed Requirements Intake<br>• **ALL requirements assigned Req IDs (FR-*, UI-*, NF-*)**<br>• **Requirements Summary (total count)**<br>• **Maturity level confirmed**<br>• Architecture compatibility analysis | • Requirements approved<br>• Req IDs assigned to ALL requirements<br>• Maturity level documented<br>• Architecture aligned |
| **3** | **Architecture Mapping & Planning** | **ALL** | • `docs/guides/implementation-plan-template.md`<br>• `docs/guides/requirements-traceability-guide.md` (for RTM creation)<br>• `docs/reference/conditional-stage-rules.md`<br>• `docs/checklists/service-naming-checklist.md`<br>• `docs/atomic/architecture/naming/README.md` (Section 2.3)<br>• `docs/atomic/services/**/*` (based on level + modules)<br>• `docs/atomic/integrations/**/*` (if needed) | • Implementation Plan with:<br>&nbsp;&nbsp;• **Requirements Traceability Matrix (ALL Req IDs mapped to tasks)**<br>&nbsp;&nbsp;• **Included features list**<br>&nbsp;&nbsp;• **Skipped features list**<br>&nbsp;&nbsp;• Conditional sub-stages<br>• Service names (DEFAULT TO 3-PART) | • Plan approved<br>• **RTM complete (all Req IDs mapped)**<br>• Features clearly marked<br>• Sub-stages identified<br>• Naming follows conventions |
...
| **5** | **Quality Verification** | **ALL** (criteria vary by level) | • `docs/quality/agent-verification-checklist.md`<br>• `docs/guides/requirements-traceability-guide.md` (for coverage verification)<br>• `docs/reference/agent-toolbox.md`<br>• `docs/reference/maturity-levels.md` (for coverage targets)<br>• `docs/reference/troubleshooting.md` (if issues) | • Completed verification checklist<br>• **Requirements Coverage Matrix (100% or approved descope)**<br>• Coverage reports (HTML + XML)<br>• Evidence logs/screenshots | **ALL checks must pass**:<br>✅ **Requirements coverage: 100%** (PRIMARY GATE)<br>✅ Linting (Ruff): 0 errors<br>✅ Formatting: No drift<br>✅ Type checking (Mypy): 0 errors<br>✅ Security (Bandit): 0 high severity<br>✅ Tests: All pass<br>✅ Test coverage: **Level-dependent** (60%/75%/80%/85%)<br>✅ Project structure: Compliant<br>✅ Naming: Follows conventions |
| **6** | **QA Report & Handoff** | **ALL** | • `docs/quality/qa-report-template.md`<br>• `docs/guides/requirements-traceability-guide.md` (for final coverage matrix)<br>• `docs/reference/deliverables-catalog.md` | • Final QA Report with:<br>&nbsp;&nbsp;• **Requirements Coverage Matrix (complete)**<br>&nbsp;&nbsp;• Overall Coverage Summary<br>• Deliverables summary<br>• Deployment guide<br>• Updated DELIVERABLES_CATALOG | • QA report approved by stakeholder<br>• **100% requirements coverage documented**<br>• All deliverables documented<br>• Deployment instructions verified<br>• Sign-off obtained |
